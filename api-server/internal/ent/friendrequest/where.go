...
func HasFrom() predicate.FriendRequest {
	return predicate.FriendRequest(func(s *sql.Selector) {
...
func HasFromWith(preds ...predicate.User) predicate.FriendRequest {
	return predicate.FriendRequest(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasTo() predicate.FriendRequest {
	return predicate.FriendRequest(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasToWith(preds ...predicate.User) predicate.FriendRequest {
	return predicate.FriendRequest(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
